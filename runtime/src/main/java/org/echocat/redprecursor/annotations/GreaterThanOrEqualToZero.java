...
import org.echocat.redprecursor.annotations.GreaterThanOrEqualToZero.Evaluator;
...
public @interface GreaterThanOrEqualToZero {
    ...
    public static class Evaluator implements AnnotationEvaluator<GreaterThanOrEqualToZero, Number> {

        @Override
        public void evaluate(@Nonnull GreaterThanOrEqualToZero annotation, @Nonnull ElementType elementType, @Nonnull String elementName, @Nullable Number value) {
