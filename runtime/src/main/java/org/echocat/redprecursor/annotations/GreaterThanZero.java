...
import org.echocat.redprecursor.annotations.GreaterThanZero.Evaluator;
...
public @interface GreaterThanZero {
    ...
    public static class Evaluator implements AnnotationEvaluator<GreaterThanZero, Number> {

        @Override
        public void evaluate(@Nonnull GreaterThanZero annotation, @Nonnull ElementType elementType, @Nonnull String elementName, @Nullable Number value) {
            if (value == null || !(value.doubleValue() > 0)) {
                throwMessageFor(annotation, " is not greater than zero.", elementType, elementName, value);
            }
        }
    }
}
