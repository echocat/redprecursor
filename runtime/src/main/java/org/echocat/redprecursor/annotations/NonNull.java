...
public @interface NonNull {
    ...
    public static class Evaluator implements AnnotationEvaluator<NonNull, Object> {
        ...
        public void evaluate(@Nonnull NonNull annotation, @Nonnull ElementType elementType, @Nonnull String elementName, @Nullable Object value) {
            if (value == null) {
                throwMessageFor(NullPointerException.class, annotation, " is null.", elementType, elementName, value);
            }
        }
    }
}
