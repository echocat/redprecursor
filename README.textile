...
* "compilerplugin.jar-bundled.jar":https://repo.echocat.org/redprecursor-snapshots/org/echocat/redprecursor/compilerplugin/0.1.0-SNAPSHOT/compilerplugin-0.1.0-SNAPSHOT-bundled.jar - Include this jar in the classpath while compile of your application. _IMPORTANT: Do not bunlde it with your application._
